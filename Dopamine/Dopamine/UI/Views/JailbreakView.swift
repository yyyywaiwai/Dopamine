...
//                .animation(.spring().speed(1.5), value: shouldShowBackground)
    ...
    func checkForUpdates() async throws {
        ...
        let releaseJSON = try JSONSerialization.jsonObject(with: releaseData, options: []) as! [String: Any]
        ...
        if liamUpdate {
            ...
            if currentAppVersion != nil && isInstalledEnvironmentVersionMismatching() {
                ...
                let upstreamReleasesJSON = try JSONSerialization.jsonObject(with: upstreamReleasesData, options: []) as! [[String: Any]]
